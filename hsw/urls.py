...
urlpatterns = [
  ...
  path("process-of-applications/", views.applications, name="companies"),
  path("process-of-applications/delete/<path:company>", views.deleteCompany),
  path("resv_list/", views.ajax_resv_list),
  path("app-org", views.app_org),
  path("important-files/documents/<path:path>", views.download), 
